...
https://drive.google.com/drive/folders/1UkLNH1VVUUYqYOEcstlH1QHKjias8QoT

### DETECTION + TRACKING FPS 

14-17 FPS for online detection and tracking on T4 Collab GPU, and 25-27 FPS for offline detection and tracking due to batch processing 
...
### Setup and runnning
Open main.py and set up your input paths, ground truth paths and model ckpt to match your setup and run python main.py and for further analysis you can run my jupyter notebook.
